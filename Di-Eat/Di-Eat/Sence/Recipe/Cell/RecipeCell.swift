...
class RecipeCell: UITableViewCell {
    ...
    private let recipeCellImageView: UIImageView = {
...
//        self.dateLabel.text = data.getTransactionData()
    ...
    private func setUI() {
        ...
        [self.recipeCellImageView, self.nameLabel, self.typeLabel, self.amountLabel, self.dateLabel].forEach {
            self.contentView.addSubview($0)
        }
    }
    
    private func setConstraints() {
        self.recipeCellImageView.snp.makeConstraints { make in
        ...
        self.nameLabel.snp.makeConstraints { make in
            make.leading.equalTo(self.recipeCellImageView.snp.trailing).offset(20)
            make.bottom.equalTo(self.recipeCellImageView.snp.centerY)
        ...
        self.typeLabel.snp.makeConstraints { make in
            make.top.equalTo(self.recipeCellImageView.snp.centerY)
